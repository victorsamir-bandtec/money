...
- [x] Criar novo componente `ProjectionCardView.swift` com design profissional (Novo Padrão). 💡 Skill: `ios-ui-crafter`
- [x] Atualizar `HistoricalAnalysisScene.swift` para usar os novos cards. 💡 Skill: `ios-ui-crafter`
- [x] Ajustar layout e espaçamento da seção de projeções. 💡 Skill: `ios-ui-crafter`
- [x] Tarefa: Conductor - Verificação Manual do Usuário 'Fase 2' (Protocolo em workflow.md).
...
- [x] Verificar acessibilidade (Dynamic Type e Labels) nos novos cards. 💡 Skill: `ios-ui-crafter`
- [x] Tarefa: Conductor - Verificação Manual do Usuário 'Fase 3' (Protocolo em workflow.md).
